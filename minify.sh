...
cat jquery.min.js jquery-ui.min.js ol.js fe.min.js map.min.js url_tools.min.js highcharts.js icheck.min.js geostats.min.js jquery.dataTables.min.js tooltip.js popover.js focus-element-overlay.min.js > m.js
