...
cat fe.min.css brand.min.css orange.min.css jquery-ui-1.8.22.custom.min.css fa/css/font-awesome.min.css jquery.dataTables.min.css geostats.min.css > m.css

cd ../js

cat jquery.min.js jquery-ui.min.js openlayers/OpenLayers.min.js fe.min.js map.min.js url_tools.min.js highcharts.js icheck.min.js geostats.min.js jquery.dataTables.min.js focus-element-overlay.min.js > m.js
